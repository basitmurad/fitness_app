...
//               SimpleTextWidget(
//                 text: userName, // Display user name
//                 fontWeight: FontWeight.w500,
//                 fontSize: 20,
//                 color: dark ? AppColor.white : AppColor.black,
//                 fontFamily: 'Poppins',
...
//               ),
//               SimpleTextWidget(
//                 text: 'You may know “$userName”', // Static text
...
//   const UserCard1({super.key, required this.dark, required this.userName});
//
//   final bool dark;
//   final String userName; // Store userName
//
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return UserCard(
                        dark: dark,
                        userName: user['name'],
                        onRemove: () => onRemove(user['id']), // Pass the onRemove method
...
class UserCard extends StatelessWidget {
  const UserCard({
    ...
    required this.onRemove, // Add onRemove parameter
  });
...
//               ),
//               SimpleTextWidget(
//                 text: 'You may know “Miachel”', // Static text
//                 fontWeight: FontWeight.w300,
//                 fontSize: 14,
//                 color: dark ? AppColor.white : AppColor.black,
//                 fontFamily: 'Poppins',
