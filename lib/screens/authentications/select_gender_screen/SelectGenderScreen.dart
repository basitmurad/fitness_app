  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: BottomAppBar(
        ...
        child: Obx(() {
          final opacity = selectGenderController.isGenderSelected.value ? 0.9 : 0.4;
          return Opacity(
            opacity: opacity,
            child: Padding(
                        ...
                        child: Obx(() => AnimatedOpacity(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: selectGenderController.selectedGender.value == 'Female' ? AppColor.orangeColor : (dark ? Colors.grey[800] : Colors.white),
                              ...
                              children: [
                                Text(
                                  ...
                                  style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                                    color: selectGenderController.selectedGender.value == 'Female' ? Colors.white : (dark ? Colors.white : AppColor.black),
                                    fontSize: 20,
                      ...
                      child: GestureDetector(
                        ...
                        child: Obx(() => AnimatedOpacity(
                          ...
                          child: Container(
                            ...
                            width: 167,
                            decoration: BoxDecoration(
                              color: selectGenderController.selectedGender.value == 'Male'
                                  ? AppColor.orangeColor
                                  : (dark ? Colors.grey[800] : Colors.white), // Changed background color
                              borderRadius: BorderRadius.circular(10),
                              boxShadow: [
                                BoxShadow(
                                  color: Colors.black.withOpacity(0.2),
                              ...
                              children: [
                                Text(
                                  ...
                                  style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                                    color: selectGenderController.selectedGender.value == 'Male'
                                        ? Colors.white
                                        : (dark ? Colors.white : AppColor.black), // Adjusted text color
                                    fontSize: 20,
                                    fontWeight: FontWeight.w500,
                                  ),
                                ),
                                ...
                                Icon(
                                  ...
                                  color: selectGenderController.selectedGender.value == 'Male'
                                      ? Colors.white
                                      : (dark ? Colors.white : AppColor.black), // Adjusted icon color
                                ),
                              ],
                            ),
                          ),
