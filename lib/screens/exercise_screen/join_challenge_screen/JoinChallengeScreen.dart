...
//             text: AppStrings.textJoinChallenge,
...
//         child: Padding(padding: const EdgeInsets.symmetric(vertical: 10 , horizontal: 10) ,child: Column(
//           children: [
//
//
//             ChallengeWidget(dark: dark),
//
//
//           ],
//         ),),
...
//             blurRadius: 6, // Blur radius for a smooth shadow
//             offset: const Offset(0, 3), // Offset in the x and y direction
//           ),
//         ],
//         border: Border.all(
//           color: Colors.grey.shade300, // Optional: Border around the card
//           width: 1,
//         ),
//       ),
//       child: Row(
...
//               children: [
//
//               SimpleTextWidget(text: '30 day Challenge', fontWeight: FontWeight.w600, fontSize: 15, color: dark ? AppColor.white: AppColor.black, fontFamily: 'Poppins')
//
//                 ,const SizedBox(height: 6,)
//               ,SimpleTextWidget(text: '1.2k people following challenge', fontWeight: FontWeight.w300, fontSize: 12, color: dark ? AppColor.white: AppColor.black, fontFamily: 'Poppins')
//
//                 ,const SizedBox(height: 6,)
//
//                 ,GestureDetector(
//
//                     onTap: (){},
//                     child: const SimpleTextWidget(text: 'see more', fontWeight: FontWeight.w500, fontSize: 12, color: AppColor.orangeColor, fontFamily: 'Poppins'))
//             ],),
//           ),
...
//             child: ButtonWidget(
//
//                 dark: dark, onPressed: (){}, buttonText: 'Join'),
//           )
//         ],
//       )
//       );
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Add more fields as needed to show details about the challenge
        ],
      ),
    );
  }
