              ...
              children: [
                ...
                Obx(() => Opacity(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      FocusScope.of(context).requestFocus(nameScreenController.focusNodeFirstName);
                    },
                    child: TextInputWidget(
                      headerText: 'Enter first name',
                      hintText: 'First Name',
                      focusNode: nameScreenController.focusNodeFirstName,
                ...
                Obx(() => Opacity(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      FocusScope.of(context).requestFocus(nameScreenController.focusNodeLastName);
                    },
                    child: TextInputWidget(
                      headerText: 'Enter last name',
                      hintText: 'Last Name',
                      focusNode: nameScreenController.focusNodeLastName,
